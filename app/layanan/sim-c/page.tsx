...
const pageTitle = `Jasa Perpanjang SIM C | ${siteName}`;
const pageDescription =
  "Jasa perpanjang SIM C dengan persyaratan jelas (SIM A asli, KTP asli, surat kuasa) dan alur proses transparan. BiroJasa Manggala Indonesia bantu kamu tanpa antre & bolak-balik. Konsultasi gratis via WhatsApp +6285324188967.";
...
export const metadata: Metadata = {
  ...
  keywords: [
    "jasa perpanjang SIM C",
    "perpanjang SIM C",
    "syarat perpanjang SIM C",
    "cara perpanjang SIM C",
    "biro jasa SIM C",
    "biro jasa perpanjang SIM C",
    "tanpa antre perpanjang SIM C",
    "urus SIM cepat",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "BiroJasa Manggala Indonesia — Jasa Perpanjang SIM C",
      },
    ],
  },
  twitter: {
...
export default function PerpanjangsimaPage() {
  const waMessage =
    "Assalamualaikum admin, saya mau tanya perihal perpanjang SIM C.";
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        url: canonical,
        name: "Jasa Perpanjang SIM C — Cepat & Tanpa Ribet",
        description: pageDescription,
        inLanguage: "id-ID",
      ...
      },
      {
        ...
        name: "Jasa Perpanjang SIM C",
        serviceType: "Perpanjang SIM C",
        url: canonical,
        description:
          "Layanan bantuan perpanjang SIM C dengan persyaratan jelas, komunikasi status yang responsif, dan proses yang rapi agar tidak perlu antre dan bolak-balik.",
        provider: { "@id": `${siteUrl}#Birojasa-Manggala` },
        areaServed: ["Tasikmalaya", "Singaparna", "JawaBarat"],
        audience: {
          "@type": "Audience",
          audienceType:
            "Pemilik kendaraan yang ingin perpanjang SIM C tanpa ribet",
        },
        availableChannel: [
          {
            "@type": "ServiceChannel",
    ...
    <>
      ...
      <main>
        <HeroService
          ...
          badgeText="Layanan SIM C"
          primaryCtaLabel="Konsultasi Gratis"
          primaryCtaMessage="Assalamualaikum admin, saya mau tanya perihal perpanjang SIM C."
        ...
        <BenefitsSummary
          heading="Ringkasan manfaat perpanjang SIM C"
          ...
          items={[
            ...
            },
            {
              ...
              description:
                "Untuk SIM C, umumnya: SIM C ASLI, KTP asli, dan surat kuasa (jika diwakilkan).",
            },
            {
        ...
        <PersyaratanDokumen
          heading="Persyaratan perpanjang SIM C"
        ...
        <AlurProses
          heading="Alur proses perpanjang SIM C"
          ...
          steps={[
            ...
            },
            {
              ...
              description:
                "Kami cek dokumen yang kamu punya dan pastikan sesuai (SIM C ASLI, KTP asli, surat kuasa bila diwakilkan).",
            },
            {
        ...
        <Estimasi
          heading="Estimasi perpanjang SIM C"
          ...
          points={[
            {
              ...
              description:
                "Berkas yang lengkap dan sesuai (SIM C ASLI, KTP asli, surat kuasa bila diwakilkan) bikin proses lebih lancar.",
            },
            {
        ...
        <FaqMini
          kickerText="FAQ SIM C"
          title="Pertanyaan umum sebelum perpanjang SIM C"
          subtitle="Jawaban ringkas biar kamu paham alurnya dari awal—tanpa bingung, tanpa bolak-balik."
          waMessage="Assalamualaikum admin, saya mau tanya perihal perpanjang SIM C."
          faqs={[
            {
              q: "Apa saja syarat perpanjang SIM C?",
              a: "Umumnya: SIM C ASLI, KTP asli, dan surat kuasa jika pengurusan diwakilkan. Jika ada kondisi khusus pada dokumen, kami informasikan setelah pengecekan.",
            },
            {
              q: "Apakah perpanjang SIM C perlu cek fisik?",
        ...
        <CtaClosingService
          heading="Siap beresin SIM C tanpa ribet?"
